...
def fetch_and_save_static_docs():
...
if __name__ == "__main__":
    print("Fetching speciationgenomics.github.io into static_docs/...")
    fetch_and_save_static_docs()
    print("Building FAISS index in faiss_index_static/...")
    build_static_faiss_index()
    print("Done.")
